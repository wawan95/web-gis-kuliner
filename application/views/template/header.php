...
<!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCOzjSAvtaf2tLaVAt9r01Is6fFwKaD1T8" type="text/javascript"></script> -->

<script type="text/javascript">
<?php echo $map['js']; ?> //tambahan
</script>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <!-- <li class="user-header">
                <img src="<#?php echo base_url();?>/assets/backend/dist/img/avatar5.png" class="img-circle" alt="User Image"> -->
<!-- 
                <p>
